import * as Module from '../OpenAIModelGateway';
...
describe('OpenAIModelGateway', () => {
  ...
  it('constructs OpenAIModelGateway', () => {
    const instance = new (OpenAIModelGateway as any)('key');
    expect(instance).toBeInstanceOf(OpenAIModelGateway);
  });
});

import * as Module from '../ChatbotModelGatewayFactory';
import { ChatbotModelGatewayFactory } from '../ChatbotModelGatewayFactory';
describe('ChatbotModelGatewayFactory', () => {
  beforeEach(() => {
  ...
  it('constructs ChatbotModelGatewayFactory', () => {
    const instance = new (ChatbotModelGatewayFactory as any)('key');
    expect(instance).toBeInstanceOf(ChatbotModelGatewayFactory);
  });
});

import * as Module from '../HuggingFaceModelGateway';
import { HuggingFaceModelGateway } from '../HuggingFaceModelGateway';
describe('HuggingFaceModelGateway', () => {
  beforeEach(() => {
  ...
  it('constructs HuggingFaceModelGateway', () => {
    const instance = new (HuggingFaceModelGateway as any)('key');
    expect(instance).toBeInstanceOf(HuggingFaceModelGateway);
  });
});

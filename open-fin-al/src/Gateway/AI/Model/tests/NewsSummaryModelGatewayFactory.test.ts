import * as Module from '../NewsSummaryModelGatewayFactory';
import { NewsSummaryModelGatewayFactory } from '../NewsSummaryModelGatewayFactory';
describe('NewsSummaryModelGatewayFactory', () => {
  beforeEach(() => {
  ...
  it('constructs NewsSummaryModelGatewayFactory', () => {
    const instance = new (NewsSummaryModelGatewayFactory as any)('key');
    expect(instance).toBeInstanceOf(NewsSummaryModelGatewayFactory);
  });
});

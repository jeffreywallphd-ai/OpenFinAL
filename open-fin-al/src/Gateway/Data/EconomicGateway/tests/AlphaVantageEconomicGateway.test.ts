import * as Module from '../AlphaVantageEconomicGateway';
import { AlphaVantageEconomicGateway } from '../AlphaVantageEconomicGateway';
describe('AlphaVantageEconomicGateway', () => {
  beforeEach(() => {
  ...
  it('constructs AlphaVantageEconomicGateway', () => {
    const instance = new (AlphaVantageEconomicGateway as any)('key');
    expect(instance).toBeInstanceOf(AlphaVantageEconomicGateway);
  });
});

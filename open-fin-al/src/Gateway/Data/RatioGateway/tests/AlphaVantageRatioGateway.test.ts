import * as Module from '../AlphaVantageRatioGateway';
import { AlphaVantageRatioGateway } from '../AlphaVantageRatioGateway';
describe('AlphaVantageRatioGateway', () => {
  beforeEach(() => {
  ...
  it('constructs AlphaVantageRatioGateway', () => {
    const instance = new (AlphaVantageRatioGateway as any)('key');
    expect(instance).toBeInstanceOf(AlphaVantageRatioGateway);
  });
});

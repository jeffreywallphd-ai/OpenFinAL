import * as Module from '../FinancialReportGatewayFactory';
import { SecReportGatewayFactory } from '../FinancialReportGatewayFactory';
describe('FinancialReportGatewayFactory', () => {
  beforeEach(() => {
  ...
  it('constructs SecReportGatewayFactory', () => {
    const instance = new (SecReportGatewayFactory as any)('key');
    expect(instance).toBeInstanceOf(SecReportGatewayFactory);
  });
});

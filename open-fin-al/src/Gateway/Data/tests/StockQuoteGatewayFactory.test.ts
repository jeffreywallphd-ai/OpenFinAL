import * as Module from '../StockQuoteGatewayFactory';
import { StockQuoteGatewayFactory } from '../StockQuoteGatewayFactory';
describe('StockQuoteGatewayFactory', () => {
  beforeEach(() => {
  ...
  it('constructs StockQuoteGatewayFactory', () => {
    const instance = new (StockQuoteGatewayFactory as any)('key');
    expect(instance).toBeInstanceOf(StockQuoteGatewayFactory);
  });
});

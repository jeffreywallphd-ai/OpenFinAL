import * as Module from '../MarketStatusGatewayFactory';
import { MarketStatusGatewayFactory } from '../MarketStatusGatewayFactory';
describe('MarketStatusGatewayFactory', () => {
  beforeEach(() => {
  ...
  it('constructs MarketStatusGatewayFactory', () => {
    const instance = new (MarketStatusGatewayFactory as any)('key');
    expect(instance).toBeInstanceOf(MarketStatusGatewayFactory);
  });
});

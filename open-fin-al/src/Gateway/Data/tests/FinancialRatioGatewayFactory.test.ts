import * as Module from '../FinancialRatioGatewayFactory';
import { FinancialRatioGatewayFactory } from '../FinancialRatioGatewayFactory';
describe('FinancialRatioGatewayFactory', () => {
  beforeEach(() => {
  ...
  it('constructs FinancialRatioGatewayFactory', () => {
    const instance = new (FinancialRatioGatewayFactory as any)('key');
    expect(instance).toBeInstanceOf(FinancialRatioGatewayFactory);
  });
});

import * as Module from '../YFinanceStockGateway';
...
describe('YFinanceStockGateway', () => {
  ...
  it('constructs YFinanceStockGateway', () => {
    const instance = new (YFinanceStockGateway as any)('key');
    expect(instance).toBeInstanceOf(YFinanceStockGateway);
  });
});

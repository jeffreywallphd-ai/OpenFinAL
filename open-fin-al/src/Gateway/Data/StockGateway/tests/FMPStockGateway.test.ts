import * as Module from '../FMPStockGateway';
import { FinancialModelingPrepGateway } from '../FMPStockGateway';
describe('FMPStockGateway', () => {
  beforeEach(() => {
  ...
  it('constructs FinancialModelingPrepGateway', () => {
    const instance = new (FinancialModelingPrepGateway as any)('key');
    expect(instance).toBeInstanceOf(FinancialModelingPrepGateway);
  });
});

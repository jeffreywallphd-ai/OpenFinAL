import * as Module from '../AlphaVantagMarketGateway';
import { AlphaVantageMarketGateway } from '../AlphaVantagMarketGateway';
describe('AlphaVantagMarketGateway', () => {
  beforeEach(() => {
  ...
  it('constructs AlphaVantageMarketGateway', () => {
    const instance = new (AlphaVantageMarketGateway as any)('key');
    expect(instance).toBeInstanceOf(AlphaVantageMarketGateway);
  });
});

import * as Module from '../SQLiteTableCreationGateway';
import { SQLiteTableCreationGateway } from '../SQLiteTableCreationGateway';
describe('SQLiteTableCreationGateway', () => {
  beforeEach(() => {
  ...
  it('constructs SQLiteTableCreationGateway', () => {
    const instance = new (SQLiteTableCreationGateway as any)('key');
    expect(instance).toBeInstanceOf(SQLiteTableCreationGateway);
  });
});

import * as Module from '../LearningModuleSQLiteDBGateway';
import { LearningModuleSQLiteDBGateway } from '../LearningModuleSQLiteDBGateway';
describe('LearningModuleSQLiteDBGateway', () => {
  beforeEach(() => {
  ...
  it('constructs LearningModuleSQLiteDBGateway', () => {
    const instance = new (LearningModuleSQLiteDBGateway as any)('key');
    expect(instance).toBeInstanceOf(LearningModuleSQLiteDBGateway);
  });
});

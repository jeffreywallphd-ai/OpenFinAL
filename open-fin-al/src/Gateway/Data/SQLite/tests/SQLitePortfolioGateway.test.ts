import * as Module from '../SQLitePortfolioGateway';
import { SQLitePortfolioGateway } from '../SQLitePortfolioGateway';
describe('SQLitePortfolioGateway', () => {
  beforeEach(() => {
  ...
  it('constructs SQLitePortfolioGateway', () => {
    const instance = new (SQLitePortfolioGateway as any)('key');
    expect(instance).toBeInstanceOf(SQLitePortfolioGateway);
  });
});

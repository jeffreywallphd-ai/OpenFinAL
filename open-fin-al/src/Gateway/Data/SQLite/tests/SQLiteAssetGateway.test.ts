import * as Module from '../SQLiteAssetGateway';
import { SQLiteAssetGateway } from '../SQLiteAssetGateway';
describe('SQLiteAssetGateway', () => {
  beforeEach(() => {
  ...
  it('constructs SQLiteAssetGateway', () => {
    const instance = new (SQLiteAssetGateway as any)('key');
    expect(instance).toBeInstanceOf(SQLiteAssetGateway);
  });
});

import * as Module from '../SQLiteUserGateway';
import { SQLiteUserGateway } from '../SQLiteUserGateway';
describe('SQLiteUserGateway', () => {
  beforeEach(() => {
  ...
  it('constructs SQLiteUserGateway', () => {
    const instance = new (SQLiteUserGateway as any)('key');
    expect(instance).toBeInstanceOf(SQLiteUserGateway);
  });
});

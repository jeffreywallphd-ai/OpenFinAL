 ...
 * @property {(payload: import('../../../domain/adaptive-learning/graph').AdaptiveGraphCatalogSyncPayload) => Promise<import('../../../domain/adaptive-learning/graph').AdaptiveGraphCatalogSyncResult>} syncAdaptiveGraphCatalog
